...
<template>
  <div class="flex flex-col gap-[10px] text-[12px] px-[15px]">
    <div>
      <div>
    ...
    <div>
      ...
      <div class="mt-[15px] text-color">
        ...
        <div class="text-active text-[15px] underline text-left mt-[10px] mb-[15px]">
          Commission reward rules
        </div>
        <div class="bg-color2 border-radius-0 p-2">
          <AffiliateSlider no-rules />
        </div>
      </div>
    </div>
  </div>
