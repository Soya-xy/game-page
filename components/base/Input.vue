...
<template>
  <div
    class="w-full rounded-[10px] flex items-center shrink-0 border-[--bc-bgColor5] border border-solid relative md:h-[46px] h-[40px] text-[14px] hover:border-[--bc-activeColor] bg-[--bc-searchColor]"
  >
